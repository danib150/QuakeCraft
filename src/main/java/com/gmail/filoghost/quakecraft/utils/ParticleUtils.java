...
public class ParticleUtils {
    ...
    public static final Color[] colors = new Color[]{Color.fromRGB(255, 0, 0), Color.fromRGB(255, 128, 0), Color.fromRGB(255, 255, 0), Color.fromRGB(128, 255, 0), Color.fromRGB(0, 255, 0), Color.fromRGB(0, 255, 128), Color.fromRGB(0, 255, 255), Color.fromRGB(0, 128, 255), Color.fromRGB(0, 0, 255), Color.fromRGB(128, 0, 255), Color.fromRGB(255, 0, 255), Color.fromRGB(255, 0, 128),};
    ...
    public static void blood(Player target) {
        ...
        org.bukkit.Particle.DustOptions dust = new org.bukkit.Particle.DustOptions(Color.RED, 1.5F);
        world.spawnParticle(org.bukkit.Particle.DUST, loc, 80, 0.4, 0.8, 0.0, 0, dust);
    }
    ...
    public static void bloodExplode(Player target) {
        ...
        org.bukkit.Particle.DustOptions dust = new org.bukkit.Particle.DustOptions(Color.RED, 2.5F);
        world.spawnParticle(org.bukkit.Particle.DUST, loc, 200, 0.8, 0.8, 0.0, 0, dust);
    }
